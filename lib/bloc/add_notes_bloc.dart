...
class AddNotesBloc {
  ...
  Future<void> saveNotes(NotesBloc notesBloc) async {
    var title = _titleStreamController.value;
    var notesDesc = _notesDescStreamController.value;
    var colorIndex = _colorStreamController.value;
    print(' default color ===>$colorIndex');
    var date = DateFormat.yMMMd().format(DateTime.now());
    await notesBloc
        .addNotes(Notes.addNotes(title, notesDesc, date, colorIndex));
  }
